...
import DisplayCartData from '../components/DisplayCartData';
const HomePage = () => {
  ...
  return (
    <div className='bgImage' style={{ backgroundImage: `url(${BgImage})` }}>
      <div className='mainContent'>
        <NavBar userId={userId} onSearchClick={() => setscrollableWindowPaddingTop("0px")} pageHeading={"cart"} />
            ...
            <div className='actualContentDiv'>
              ...
              <div className='actualContent1' >
                ...
                <div className="rightContentDiv">
                  <DisplayCartData categoryFilter={categoryFilter} searchFilter={searchFilter} hoveredTileIndex={hoveredTileIndex} onTileHover={handleTileHover} onTileLeave={handleTileLeave}/> {/* categoryFilter={categoryFilter} searchFilter={searchFilter} hoveredTileIndex={hoveredTileIndex} onTileHover={handleTileHover} onTileLeave={handleTileLeave} */}
                </div>
              </div>
